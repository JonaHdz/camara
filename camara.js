...
async function uploadFile(blob){
    ...
    const urlAzure = 'https://jonathan-webapifoto.azurewebsites.net';
    ...
    if(response.status == 201){
        ...
        img_azure.innerHTML = datos.url;
    }else{
        alert('ocurrio un error al intentar subir la iamgen:' + response.status);
    }
}